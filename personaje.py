...
class Personaje:
    ...
    def __init__(self, app, pos):
        ...
        self.img_actual = "imgs/pj2-dcha.png"
    ...
    def getPixPos(self):
        return vec((self.pos_matriz.x*self.app.ancho_celda) + (BORDE//2)+(self.app.ancho_celda//2)+1,
                   (self.pos_matriz.y*self.app.alto_celda)+(BORDE//2)+(self.app.alto_celda//2)-13)


    def dibujarPerson(self,img_inicio):
        imagen = pygame.image.load(img_inicio)
    ...
    def dibujarVidas(self):
        for x in range(self.vidas):
            imagen_vida = pygame.image.load("imgs/corazon.png")
